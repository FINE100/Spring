...
<link href="${pageContext.request.contextPath }"
	/resources/css/headers.css" rel="stylesheet">
</head>
<body>
			...
			<div class="container">
				<div
					...
					<ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
						<li>
						<!--  절대 경로로 설정해줘야함 --> 
						<a href="${pageContext.request.contextPath }/bookinsert" class="nav-link text-white"> 
						<svg class="bi d-block mx-auto mb-1" width="24" height="24">
                	<use xlink:href="#speedometer2" /></svg> 도서 등록
						</a>
						</li>
						<li>
							<!--  절대 경로로 설정해줘야함 --> <a
                ...
                <use xlink:href="#speedometer2" /></svg> 도서목록 조회/수정
						</a>
						</li>
     <li>
            <!--  절대 경로로 설정해줘야함 -->
              ...
              대여 현황 조회
						...
						<li>
							...
							class="nav-link text-secondary"> <svg
									class="bi d-block mx-auto mb-1" width="24" height="24">
